...
| @property_class@        | X    |
| @property_core@         | X    |
| @property_ast@          | _    | AST for representing a simplified view of predicates
| @property_rcollector@   | X    | _ResultCollector_, used for storing subexpression results of instrumented predicates
| @property_pvisitor@     | X    | _PropertyVisitor_ instruments _Properties_ and builds a simplied AST
| @property_covervisitor@ | X    | <sup>s</sup>: _CoverVisitor_ computes property coverage goals
| @property_covertable@   | X    | <sup>s</sup>: _CoverTable_ stores property coverage information
| @property_language@     | X    | <sup>s</sup>: DSL for defining properties
| @property_cases@        | X    |   <sup>s</sup>
